<?php
	...
	if($reqlen==0){
		...
		$sql = "INSERT INTO `Suscriptores_fr`(`NOM`,`EMAIL`) VALUES(?,?)";

    	$stmt = mysqli_prepare($link, $sql);

    	mysqli_stmt_bind_param($stmt, "ss", $_POST['NOM'], $_POST['EMAIL']);

		if (mysqli_stmt_execute($stmt)) {
    		echo utf8_decode("<br><center> Mercie. Nous vous tiendrons bien informé de nos propositions. </center>");
			} else {
