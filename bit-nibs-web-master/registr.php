<?php
	...
	if($reqlen==0){
		...
		$sql = "INSERT INTO `Suscriptores`(`NOMBRE`,`EMAIL`) VALUES(?,?)";
		...
		if (mysqli_stmt_execute($stmt)) {
    		echo utf8_decode("<br><center> Gracias por su interes en el proyecto. Lo mantendremos bien informado de nuestras propuestas. </center>");
			} else {
